...
system/priv-app/SecSettings/SecSettings.apk/smali_classes5/com/samsung/android/settings/deviceinfo/batteryinfo/SecBatteryFirstUseDatePreferenceController.smali
...
"
for f in $FTP; do
    sed -i "s/SM-A236B/SM-S926B/g" "$APKTOOL_DIR/$f"
done
